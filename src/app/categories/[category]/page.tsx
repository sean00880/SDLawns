    ...
    <div className="flex flex-col lg:flex-row gap-8 p-6 bg-pure-white min-h-screen">
      ...
      <div className="flex-grow">
        ...
        {categoryServices.services.map((service, index) => (
          <div key={service.id} className={`flex flex-col ${index % 2 === 0 ? "lg:flex-row" : "lg:flex-row-reverse"} gap-6 mb-12`}>
            <img
              src={service.img}
              alt={service.name}
            ...
            <div className="lg:w-1/2">
              ...
              <p className="text-gray-700 mb-4">{service.description.join(" ")}</p>
