...
const Header: React.FC = () => {
  ...
  return (
    <header className="glass-header sticky top-0 w-full z-50 shadow-md bg-white/90 backdrop-blur-lg">
                        ...
                        <div key={category} className="flex flex-col items-center">
                          ...
                          <div className="mt-4 w-full">
                            ...
                            <div className="text-sm text-gray-600 mb-2 flex justify-between items-center">
                              ...
                              <span className="text-black font-medium">
                                ${data.packages[0].pricing[selectedFrequency]}
                              </span>
                            </div>
                            <div className="flex justify-between mt-1">
                              <Link
                                href={`/packages/${data.packages[0].id}`}
                                className="text-green-500 hover:underline text-sm"
                              >
                                Learn More
                              </Link>
